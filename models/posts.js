...
Posts.attachSchema(new SimpleSchema({
  ...
  // froala is a wysiwyg editor.

  body: orion.attribute('froala', {
    label: orion.helpers.getTranslation('posts.schema.body') // We use this function to make i18n work in autoform
  }),

  // This attribute sets the user id of the user
  // that created this post automatically.

  createdBy: orion.attribute('createdBy'),
  createdAt: orion.attribute('createdAt')
}));

 // Using dburles:collection-helpers we will add a helper
 // to the posts collection to easily get the user
